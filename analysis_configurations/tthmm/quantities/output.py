...
bjet1_mass = Quantity("bjet1_mass")
bjet1_pt = Quantity("bjet1_pt")
bjet1_eta = Quantity("bjet1_eta")
bjet1_phi = Quantity("bjet1_phi")

bjet_p4_2 = Quantity("bjet_p4_2")
bjet2_mass = Quantity("bjet2_mass")
bjet2_pt = Quantity("bjet2_pt")
bjet2_eta = Quantity("bjet2_eta")
bjet2_phi = Quantity("bjet2_phi")
...
Ht_scalar = Quantity("Ht_scalar")
Ht_vector = Quantity("Ht_vector")
Ht_vector_pt = Quantity("Ht_vector_pt")
Ht_vector_phi = Quantity("Ht_vector_phi")
...
Flag_dielectron_Zmass_veto = Quantity("Flag_dielectron_Zmass_veto")
...
dimuon_Z_p4 = Quantity("dimuon_Z_p4")
dielectron_Z_p4 = Quantity("dielectron_Z_p4")
### 
...
extra_muon_p4 = Quantity("extra_muon_p4")
extra_electron_index = Quantity("extra_electron_index")
extra_electron_p4 = Quantity("extra_electron_p4")
...
muon_DeepCSVClosest =  Quantity("muon_DeepCSVClosest")
muon1_iso = Quantity("muon1_iso")
muon2_iso = Quantity("muon2_iso")
...
mu1_fromH_dxy = Quantity("mu1_fromH_dxy")
mu1_fromH_dz = Quantity("mu1_fromH_dz")
mu1_fromH_sip3d = Quantity("mu1_fromH_sip3d")
...
mu2_fromH_dxy = Quantity("mu2_fromH_dxy")
mu2_fromH_dz = Quantity("mu2_fromH_dz")
mu2_fromH_sip3d = Quantity("mu2_fromH_sip3d")
...
trijet_mass = Quantity("trijet_mass")
...
extra_muon_pt = Quantity("extra_muon_pt")
extra_muon_eta = Quantity("extra_muon_eta")
extra_muon_phi = Quantity("extra_muon_phi")
extra_muon_mass = Quantity("extra_muon_mass")

extra_electron_pt = Quantity("extra_electron_pt")
extra_electron_eta = Quantity("extra_electron_eta")
extra_electron_phi = Quantity("extra_electron_phi")
extra_electron_mass = Quantity("extra_electron_mass")
...
# # only for no error, all producers using variable extra_lep_p4 should be rewritten
