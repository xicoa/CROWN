...
MuonMiniIsoCut = Producer(
    name="MuonMiniIsoCut",
    call="physicsobject::CutVarMax({df}, {input}, {output}, {muon_mini_iso_cut})",
...
Mu1_H = Producer(
    ...
    scopes=["gghmm","vbfhmm","tthmm","e2m","m2m", "eemm","nnmm","fjmm"],
)
